...
> Ye file teri daily revision ke liye hai. Jo jo topic tune abhi tak cover kiya hai, sab yahan flow me hai — **Network → Host → MAC vs IP → Switch → CIDR → Subnet Mask → OSI Model → TCP/IP Model → Packet Journey**.
